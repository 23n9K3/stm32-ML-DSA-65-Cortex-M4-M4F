...
extern void pqcrystals_dilithium_ntt(int32_t a[N]);
extern void pqcrystals_dilithium_invntt_tomont(int32_t a[N]);

void PQCLEAN_MLDSA65_CLEAN_ntt(int32_t a[N]) {
    pqcrystals_dilithium_ntt(a);
}

void PQCLEAN_MLDSA65_CLEAN_invntt_tomont(int32_t a[N]) {
    pqcrystals_dilithium_invntt_tomont(a);
}
#else
